...
@Autonomous(name="Robot: Auto Drive By Encoder Right Move Sample", group="Robot")


public class AutoDriveRightMoveSample extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  -4, -4, 5.0);  // Forward
        encoderDrive(TURN_SPEED,   -24, 24, 5.0);  // Turn Right
        encoderDrive(DRIVE_SPEED, -20, -20, 5.0);  // Forward
        encoderDrive(DRIVE_SPEED, 24, -24, 5.0);  // Turn Left
        encoderDrive(DRIVE_SPEED, -50, -50, 5.0);  // Forward
        driveObject.moveRobot(0, 0.3, 0); //strafe right for 900 milliseconds
        sleep(900);
        driveObject.moveRobot(0, 0, 0);
        encoderDrive(DRIVE_SPEED, 50, 50, 5.0);  // reverse
